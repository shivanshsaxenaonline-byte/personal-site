...
https://personal-site-ivory-chi.vercel.app
<!-- WEBSITE_PREVIEW_END -->
...
A personal portfolio and technical writing site. It presents my résumé, a project archive, and posts about the business software I build — internal CRMs, management dashboards, API integrations, and workflow automation.

It is non-commercial: I sell nothing on it and it carries no advertising.

For transparency, the site is built on the MIT-licensed open source template mldangelo/personal-site, which I forked and rebranded. The content, colour system, typography, favicon, share card, and generated assets are my own, and the first post is a colophon describing those changes in detail. The layout structure is inherited from upstream and credited on the site.
<!-- WEBSITE_PURPOSE_END -->
