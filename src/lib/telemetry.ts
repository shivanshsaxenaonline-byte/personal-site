 ...
 * it is the same measurement for everyone. +05:30 is India Standard Time.
 */
/**
 * Note: `profile.birthDate` is currently a placeholder and the stats page does
 * not render the live age because of it. The machinery below is intact — put a
 * real date in `profile.json` and restore the `Age` entry in
 * `src/data/stats/personal.tsx` to switch the readout back on.
 */
