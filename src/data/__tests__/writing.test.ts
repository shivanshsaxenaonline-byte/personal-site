...
describe('writing data', () => {
  /* External writing is optional — a site with only on-site posts has an
     empty list, which is a valid state rather than a missing one. Every
     assertion below is a per-item rule and holds vacuously when empty. */
