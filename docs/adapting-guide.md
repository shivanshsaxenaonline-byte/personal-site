...
| Portrait and its alt text                                      | `public/images/portrait.jpg`, `src/components/Template/ThemePortrait.tsx`, `src/lib/utils.ts` |
...
```bash
rg -n -i "Michael|mldangelo|dangelosaurus|Bricolage|Newsreader|mldangelo\\.com|OpenAI|Promptfoo" \
